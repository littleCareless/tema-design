...
export interface TmUploadInternalRawFile extends File {
  uid: number
}
...
/** Upload Component */
export declare class TmUpload extends TmDesignUIComponent {
  ...
  beforeUpload: (file: TmUploadInternalRawFile) => boolean | Promise<File | Blob | boolean>
