        ...
        <div class="el-picker-panel__body">
          ...
          <div
            ...
            <button
              ...
              class="el-picker-panel__icon-btn el-date-picker__prev-btn tm-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="el-picker-panel__icon-btn el-date-picker__prev-btn tm-icon-arrow-left">
            </button>
            <span
            ...
            <button
              ...
              class="el-picker-panel__icon-btn el-date-picker__next-btn tm-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="el-picker-panel__icon-btn el-date-picker__next-btn tm-icon-arrow-right">
            </button>
          </div>
...
<script type="text/babel">
  import {
    ...
    extractTimeFormat,
    timeWithinRange
  } from 'tema-ui/src/utils/date-util';
  ...
  export default {
    ...
    watch: {
      showTime(val) {
        ...
        if (!val) return;
        this.$nextTick(_ => {
          const inputTmm = this.$refs.input.$el;
          if (inputTmm) {
            this.pickerWidth = inputTmm.getBoundingClientRect().width + 10;
          }
        });
      },
