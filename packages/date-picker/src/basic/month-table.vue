...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'tema-ui/src/utils/date-util';
  import { hasClass } from 'tema-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'tema-ui/src/utils/util';
