  ...
  <div class="el-time-spinner" :class="{ 'has-seconds': showSeconds }">
    ...
    <template v-if="arrowControl">
      <div
        ...
        <i v-repeat-click="decrease" class="el-time-spinner__arrow tm-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="el-time-spinner__arrow tm-icon-arrow-down"></i>
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'tema-ui/src/utils/date-util';
  import TmScrollbar from 'tema-ui/packages/scrollbar';
  import RepeatClick from 'tema-ui/src/directives/repeat-click';
