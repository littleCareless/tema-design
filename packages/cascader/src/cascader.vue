    ...
    <el-input
      ...
      <template slot="suffix">
        <i
          ...
          key="clear"
          class="el-input__icon tm-icon-circle-close"
        ...
        <tm-scrollbar
          ...
          <template v-if="suggestions.length">
            <li
              ...
              <span>{{ item.text }}</span>
              <i v-if="item.checked" class="tm-icon-check"></i>
            </li>
          </template>
...
import TmCascaderPanel from 'tema-ui/packages/cascader-panel';
import AriaUtils from 'tema-ui/src/utils/aria-utils';
import { t } from 'tema-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'tema-ui/src/utils/util';
import { isUndefined, isFunction } from 'tema-ui/src/utils/types';
import { isDef } from 'tema-ui/src/utils/shared';
...
export default {
  ...
  methods: {
    ...
    updateStyle() {
      ...
      let suggestionPanelTm = null;

      if (suggestionPanel && (suggestionPanelTm = suggestionPanel.$el)) {
        const suggestionList = suggestionPanelTm.querySelector('.el-cascader__suggestion-list');
