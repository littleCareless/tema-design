...
export default {
  ...
  methods: {
    ...
    getColumnTmIndex(children, child) {
    ...
    setColumnRenders(column) {
      ...
      if (this.renderHeader) {
        console.warn('[TmDesign Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.');
  ...
  mounted() {
    ...
    const columnIndex = this.getColumnTmIndex(children, this.$el);
