import { arrayFindIndex } from 'tema-ui/src/utils/util';
import { getCell, getColumnByCell, getRowIdentity } from './util';
import { getStyle, hasClass, removeClass, addClass } from 'tema-ui/src/utils/dom';
import TmCheckbox from 'tema-ui/packages/checkbox';
import TmTooltip from 'tema-ui/packages/tooltip';
...
export default {
  ...
  watch: {
    ...
    // update DOM manually. see https://github.com/TmemeFE/element/pull/13954/files#diff-9b450c00d0a9dec0ffad5a3176972e40
  ...
  methods: {
    ...
    rowRender(row, $index, treeRowData) {
      ...
      // 使用 :style 代替 v-show https://github.com/TmemeFE/element/issues/16995
    ...
    wrappedRowRender(row, $index) {
      ...
      if (this.hasExpandColumn && isRowExpanded(row)) {
        ...
        if (!renderExpanded) {
          console.error('[TmDesign Error]renderExpanded is required.');
          return tr;
        }
        // 使用二维数组，避免修改 $index
        return [[
