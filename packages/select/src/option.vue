...
<script type="text/babel">
  ...
  import { getValueByPath, escapeRegexpString } from 'tema-ui/src/utils/util';
    ...
    watch: {
      ...
      value(val, oldVal) {
        ...
        if (!this.created && !remote) {
          ...
          this.dispatch('TmSelect', 'setSelected');
        }
      }
    },
    ...
    methods: {
      ...
      selectOptionClick() {
        if (this.disabled !== true && this.groupDisabled !== true) {
          this.dispatch('TmSelect', 'handleOptionClick', [this, true]);
        }
      },
