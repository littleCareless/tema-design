  ...
  methods: {
    ...
    */
    ...
    scrollIntoView() {
      ...
      menus.forEach(menu => {
        const menuTmDesign = menu.$el;
        if (menuTmDesign) {
          const container = menuTmDesign.querySelector('.tm-scrollbar__wrap');
          const activeNode = menuTmDesign.querySelector('.el-cascader-node.is-active') ||
            menuTmDesign.querySelector('.el-cascader-node.in-active-path');
