<script>
  ...
  import TmRadio from 'tema-ui/packages/radio';
  import { isEqual } from 'tema-ui/src/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="tm-icon-check el-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="tm-icon-loading el-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="tm-icon-arrow-right el-cascader-node__postfix"></i>
        );
      },
