  ...
  export default {
    ...
    watch: {
      suggestionVisible(val) {
        ...
        if ($input) {
          this.broadcast('TmAutocompleteSuggestions', 'visible', [val, $input.offsetWidth]);
        }
      }
    },
    methods: {
      ...
      getData(queryString) {
        ...
        this.fetchSuggestions(queryString, (suggestions) => {
          ...
          if (Array.isArray(suggestions)) {
            ...
            console.error('[TmDesign Error][Autocomplete]autocomplete suggestions must be an array');
          }
        });
      },
      handleInput(value) {
