...
<script>
  ...
  import { on, off, getScrollContainer, isInContainer } from 'tema-ui/src/utils/dom';
  import { isString, isHtmlTmDesign } from 'tema-ui/src/utils/types';
  ...
  export default {
    ...
    methods: {
      ...
      addLazyLoadListener() {
        ...
        if (isHtmlTmDesign(scrollContainer)) {
