        ...
        <div
          ...
          <header class="el-drawer__header" id="el-drawer__title" v-if="withHeader">
            ...
            <button
              ...
              v-if="showClose"
              @click="closeDrawer">
              <i class="el-dialog__close tm-icon tm-icon-close"></i>
            </button>
          </header>
...
import Utils from 'tema-ui/src/utils/aria-utils';
  ...
  watch: {
    visible(val) {
      if (val) {
        ...
        this.prevActiveTmDesign = document.activeTmDesign;
        this.$nextTick(() => {
        ...
        this.$nextTick(() => {
          if (this.prevActiveTmDesign) {
            this.prevActiveTmDesign.focus();
          }
        });
      }
    }
