...
import TmSelect from 'tema-ui/packages/select';
import TmOption from 'tema-ui/packages/option';
import TmInput from 'tema-ui/packages/input';
import Locale from 'tema-ui/src/mixins/locale';
import { valueEquals } from 'tema-ui/src/utils/util';
    ...
    Jumper: {
      ...
      methods: {
        handleKeyup({ keyCode, target }) {
          ...
          // Hack for IE: https://github.com/TmemeFE/element/issues/11710
