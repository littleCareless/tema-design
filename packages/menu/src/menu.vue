<script type="text/jsx">
  ...
  import Menubar from 'tema-ui/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from 'tema-ui/src/utils/dom';
        ...
        if (this.router && hasIndex) {
          this.routeToItem(item, (error) => {
            ...
            if (error) {
              ...
              // https://github.com/TmemeFE/element/issues/17044
