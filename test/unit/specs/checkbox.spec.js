...
describe('Checkbox', () => {
  ...
  it('create', done => {
    ...
    let checkboxTmm = vm.$el;
    expect(checkboxTmm.classList.contains('el-checkbox')).to.be.true;
    checkboxTmm.click();
    vm.$nextTick(_ => {
      expect(checkboxTmm.querySelector('.is-checked')).to.be.ok;
      done();
    });
  });
  it('disabled', () => {
    ...
    let checkboxTmm = vm.$el;
    expect(checkboxTmm.querySelector('.is-disabled')).to.be.ok;
  });
  ...
  describe('checkbox-button', () => {
    ...
    it('create', done => {
      ...
      let checkboxTmm = vm.$el;
      expect(checkboxTmm.classList.contains('el-checkbox-button')).to.be.true;
      checkboxTmm.click();
      vm.$nextTick(_ => {
        expect(checkboxTmm.classList.contains('is-checked')).to.be.ok;
        done();
      });
    });
    it('disabled', () => {
      ...
      let checkboxTmm = vm.$el;
      expect(checkboxTmm.classList.contains('is-disabled')).to.be.ok;
    });
