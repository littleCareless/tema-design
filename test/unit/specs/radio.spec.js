...
describe('Radio', () => {
  ...
  it('create', done => {
    ...
    let radioTmm = vm.$el;
    expect(radioTmm.classList.contains('el-radio')).to.be.true;
    radioTmm.click();
    setTimeout(_ => {
      expect(radioTmm.querySelector('.is-checked')).to.be.ok;
      done();
    }, 10);
  });
  it('disabled', done => {
    ...
    setTimeout(_ => {
      ...
      expect(radioTmm.querySelector('.is-disabled')).to.be.ok;
      done();
    }, 10);
  });
  it('border', () => {
    ...
    let radioTmm = vm.$el;
    expect(radioTmm.classList.contains('is-bordered')).to.be.true;
  });
  ...
  describe('Radio group', () => {
    it('create', done => {
      ...
      setTimeout(_ => {
        ...
        let radioTmm = vm.$refs.radio2.$el;
        radioTmm.click();
        setTimeout(_ => {
          expect(radioTmm.querySelector('.is-checked')).to.be.ok;
