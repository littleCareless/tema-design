...
describe('Menu', () => {
  ...
  it('horizontal mode', done => {
    ...
    setTimeout(_ => {
      expect(document.body.querySelector('.el-menu--popup').parentTmDesign.style.display).to.not.ok;
      done();
    }, 500);
  });
  it('menu trigger click', done => {
    ...
    expect(vm.$el.classList.contains('el-menu--horizontal')).to.be.true;
    var submenu = vm.$refs.submenu;
    var triggerTmm = submenu.$el.querySelector('.el-submenu__title');
    ...
    setTimeout(_ => {
      ...
      triggerTmm.click();
      setTimeout(_ => {
        expect(document.body.querySelector('.el-menu--popup').parentTmDesign.style.display).to.be.equal('none');
        done();
      }, 1000);
    }, 500);
  });
      ...
      template: `
        <el-menu mode="vertical" default-active="1">
          <el-menu-item-group title="分组一" ref="group1">
            <el-menu-item index="1"><i class="tm-icon-message"></i>导航一</el-menu-item>
            <el-menu-item index="2"><i class="tm-icon-message"></i>导航二</el-menu-item>
          </el-menu-item-group>
          <el-submenu index="5">
