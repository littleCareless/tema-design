...
describe('DatePicker', () => {
  ...
  it('select date', done => {
    ...
    setTimeout(_ => {
      ...
      const arrowLeftTmm = $el.querySelector('.el-date-picker__prev-btn.tm-icon-arrow-left');
      const arrowRightTmm = $el.querySelector('.el-date-picker__next-btn.tm-icon-arrow-right');

      expect(spans[0].textContent).to.include(date.getFullYear());
      expect(spans[1].textContent).to.include(date.getMonth() + 1);
      $el.querySelector('.el-date-picker__prev-btn.tm-icon-d-arrow-left').click();
      let count = 20;
      while (--count) {
        arrowLeftTmm.click();
      }
  ...
  it('reset', done => {
    ...
    setTimeout(_ => {
      const $el = vm.$refs.compo.picker.$el;
      $el.querySelector('.el-date-picker__next-btn.tm-icon-arrow-right').click();
      setTimeout(_ => {
        $el.querySelector('td.available').click();
        vm.$nextTick(_ => {
          vm.value = '';
  ...
  describe('value-format', () => {
    ...
    it('with literal string', done => {
      vm = createVue({
        template: `
          <el-date-picker
            ...
            v-model="value"
            type="date"
            value-format="dd/MM yyyy [TmDesign]" />`,
        data() {
          return {
            value: ''
          };
      ...
      setTimeout(_ => {
        ...
        setTimeout(_ => {
          ...
          const MM = ('0' + (today.getMonth() + 1)).slice(-2);
          const dd = '01'; // first available one should be first day of month
          const expectValue = `${dd}/${MM} ${yyyy} TmDesign`;
          expect(vm.value).to.equal(expectValue);
          done();
        }, DELAY);
      }, DELAY);
    ...
    it('translates format to value-format with literal string', done => {
      ...
      input.focus();
      setTimeout(_ => {
        input.value = 'TmDesign 2000-10-01';
        triggerEvent(input, 'input');
        keyDown(input, ENTER);
        setTimeout(_ => {
  ...
  describe('default value', () => {
    ...
    it('it works', done => {
      ...
      setTimeout(_ => {
        ...
        const defaultTms = $el.querySelectorAll('.el-date-table td.default');
        expect(defaultTms.length).to.equal(1);
        defaultTms[0].click();
        setTimeout(_ => {
  ...
  describe('type:datetime', () => {
      ...
      it('pick date, emits on confirm', done => {
        ...
        setTimeout(_ => {
          ...
          setTimeout(_ => {
            ...
            vm.$refs.compo.picker.$el.querySelector('.el-picker-panel__footer .tm-button--default').click();
            setTimeout(_ => {
    ...
    it('now button: can not choose disabled date', done => {
      ...
      setTimeout(_ => {
        // click now button
        vm.$refs.compo.picker.$el.querySelector('.el-picker-panel__footer .tm-button--text').click();
        setTimeout(_ => {
          expect(vm.value).to.equal('');
          done();
        }, DELAY);
    ...
    it('select time honors picked date', done => {
      ...
      setTimeout(_ => {
        ...
        vm.$refs.compo.picker.$el.querySelector('.el-date-picker__header .tm-icon-arrow-right').click();
        setTimeout(_ => {
          vm.$refs.compo.picker.$el.querySelector('.el-date-picker__header .tm-icon-d-arrow-right').click();
          setTimeout(_ => {
  ...
  describe('type:week', () => {
    ...
    it('highlight correctly', done => {
      ...
      setTimeout(() => {
        const pickerTm = vm.$refs.compo.picker.$el;
        const numberOfHighlightRows = () => pickerTm.querySelectorAll('.el-date-table__row.current').length;
        expect(numberOfHighlightRows()).to.equal(0);
        setTimeout(() => {
          pickerTm.querySelector('.el-date-table__row ~ .el-date-table__row td.available').click();
          setTimeout(() => {
            expect(vm.value).to.exist;
            input.blur();
            input.focus();
            setTimeout(() => {
              ...
              pickerTm.querySelector('.tm-icon-arrow-right').click();
              setTimeout(() => {
                expect(numberOfHighlightRows()).to.equal(0);
                // test: next year should not have highlight
                pickerTm.querySelector('.tm-icon-arrow-left').click(); // go back one month
                pickerTm.querySelector('.tm-icon-d-arrow-right').click();
                setTimeout(() => {
                  expect(numberOfHighlightRows()).to.equal(0);
                  done();
                }, DELAY);
  ...
  describe('type:daterange', () => {
    ...
    describe('default value', () => {
      ...
      it('array', done => {
        ...
        vm.$el.querySelector('input').focus();
        setTimeout(_ => {
          const defaultTms = vm.$refs.compo.picker.$el.querySelectorAll('.el-date-table td.default');
          expect(defaultTms.length).to.equal(2);
          defaultTms[0].click();
          setTimeout(_ => {
            defaultTms[1].click();
            setTimeout(_ => {
  ...
  describe('type:monthrange', () => {
    ...
    describe('default value', () => {
      ...
      it('single', done => {
        ...
        setTimeout(_ => {
          const $el = vm.$refs.compo.picker.$el;
          const defaultTms = $el.querySelectorAll('.el-month-table td.default');
          expect(defaultTms.length).to.equal(1);
          defaultTms[0].click();
          setTimeout(_ => {
      ...
      it('array', done => {
        ...
        vm.$el.querySelector('input').focus();
        setTimeout(_ => {
          const defaultTms = vm.$refs.compo.picker.$el.querySelectorAll('.el-month-table td.default');
          expect(defaultTms.length).to.equal(2);
          defaultTms[0].click();
          setTimeout(_ => {
            defaultTms[1].click();
  ...
  describe('picker-options:firstDayOfWeek issue-14523', () => {
    ...
    it('set value equal to 2019-01-01', done => {
      ...
      setTimeout(_ => {
        const currentTmDesign = vm.picker.$el.querySelector('tr:nth-child(2) td:nth-child(7) span');
        const lastPrevMonthTmDesign = vm.picker.$el.querySelector('tr:nth-child(2) td:nth-child(6) span');
        expect(currentTmDesign.innerText.trim()).to.equal('1');
        expect(lastPrevMonthTmDesign.innerText.trim()).to.equal('31');
        done();
      }, DELAY);
    });
    ...
    it('set value equal to 2018-01-01', done => {
      ...
      setTimeout(_ => {
        const currentTmDesign = vm.picker.$el.querySelector('tr:nth-child(2) td:nth-child(6) span');
        const lastPrevMonthTmDesign = vm.picker.$el.querySelector('tr:nth-child(2) td:nth-child(5) span');
        expect(currentTmDesign.innerText.trim()).to.equal('1');
        expect(lastPrevMonthTmDesign.innerText.trim()).to.equal('31');
        done();
      }, DELAY);
