...
describe('TimePicker', () => {
  ...
  it('set AM/PM format', done => {
    ...
    setTimeout(_ => {
      ...
      expect(hoursTm.querySelectorAll('.el-time-spinner__item')[0].textContent).to.equal('12 AM');
      expect(hoursTm.querySelectorAll('.el-time-spinner__item')[1].textContent).to.equal('01 AM');
      expect(hoursTm.querySelectorAll('.el-time-spinner__item')[12].textContent).to.equal('12 PM');
      expect(hoursTm.querySelectorAll('.el-time-spinner__item')[15].textContent).to.equal('03 PM');
      done();
    }, DELAY);
  });
  ...
  it('select time', done => {
    ...
    setTimeout(_ => {
      ...
      const secondsTm = list[2];
      const hourTm = hoursTm.querySelectorAll('.el-time-spinner__item')[4];
      const minuteTm = minutesTm.querySelectorAll('.el-time-spinner__item')[36];
      const secondTm = secondsTm.querySelectorAll('.el-time-spinner__item')[20];
      ...
      vm.$nextTick(_ => {
        ...
        vm.$nextTick(_ => {
          ...
          setTimeout(_ => {
            ...
            expect(hourTm.classList.contains('active')).to.true;
            expect(minuteTm.classList.contains('active')).to.true;
            expect(secondTm.classList.contains('active')).to.true;
  ...
  it('selectableRange', done => {
    ...
    setTimeout(_ => {
      ...
      hoursTm.querySelectorAll('.disabled')[0].click();
      expect(disabledHours).to.not.include.members([17, 18, 19, 20, 21, 22]);

      const minutesTm = list[1];
      hoursTm.querySelectorAll('.el-time-spinner__item')[18].click();
      setTimeout(_ => {
