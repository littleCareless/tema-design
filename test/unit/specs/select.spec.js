...
describe('Select', () => {
  ...
  it('clearable', done => {
    ...
    setTimeout(() => {
      const iconClear = vm.$el.querySelector('.el-input__icon.tm-icon-circle-close');
  ...
  it('prefixed icon', () => {
    ...
    expect(vm.$el.querySelector('.el-input__icon').classList.contains('tm-icon-search')).to.be.true;
  });
