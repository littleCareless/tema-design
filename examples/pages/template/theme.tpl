  ...
  <div class="page-container page-theme">
    ...
    <el-dialog :visible.sync="copyDialogVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <tm-button @click="closeCopyForm">{{getActionDisplayName('cancel')}}</tm-button>
        <tm-button type="primary" @click="copyToUser">{{getActionDisplayName('confirm')}}</tm-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  computed: {
    officialTheme() {
      return this.padEmpeyTheme(themeList.concat(this.$isTme ? eleThemeList : []));
    },
    userThemeCount() {
