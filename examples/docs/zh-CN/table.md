  ...
  <el-table
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <tm-button @click="handleClick(scope.row)" type="text" size="small">查看</tm-button>
        <tm-button type="text" size="small">编辑</tm-button>
      </template>
    </el-table-column>
  </el-table>
</template>
...
<template>
  ...
  <div style="margin-top: 20px">
    <tm-button @click="setCurrent(tableData[1])">选中第二行</tm-button>
    <tm-button @click="setCurrent()">取消选择</tm-button>
  </div>
</template>
...
<template>
  ...
  <div style="margin-top: 20px">
    <tm-button @click="toggleSelection([tableData[1], tableData[2]])">切换第二、第三行的选中状态</tm-button>
    <tm-button @click="toggleSelection()">取消选择</tm-button>
  </div>
</template>
...
```html
<template>
  <tm-button @click="resetDateFilter">清除日期过滤器</tm-button>
  <tm-button @click="clearFilter">清除所有过滤器</tm-button>
  <el-table
    ref="filterTable"
    :data="tableData"
    style="width: 100%">
  ...
  <el-table
    ...
    <el-table-column label="操作">
      <template slot-scope="scope">
        <tm-button
          size="mini"
          @click="handleEdit(scope.$index, scope.row)">编辑</tm-button>
        <tm-button
          size="mini"
          type="danger"
          @click="handleDelete(scope.$index, scope.row)">删除</tm-button>
      </template>
    </el-table-column>
  </el-table>
</template>
