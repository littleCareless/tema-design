...
<div class="demo-input-suffix">
  ...
  <el-input
    placeholder="请选择日期"
    v-model="input3">
    <i slot="suffix" class="el-input__icon tm-icon-date"></i>
  </el-input>
  <el-input
    placeholder="请输入内容"
    v-model="input4">
    <i slot="prefix" class="el-input__icon tm-icon-search"></i>
  </el-input>
</div>
...
<el-autocomplete
  ...
  @select="handleSelect">
  <i
    class="tm-icon-edit el-input__icon"
    slot="suffix"
...
| 参数          | 说明            | 类型            | 可选值                 | 默认值   |
|-------------  |---------------- |---------------- |---------------------- |-------- |
| type         | 类型   | string  | text，textarea 和其他 [原生 input 的 type 值](https://developer.mozilla.org/en-US/docs/Web/HTML/TmDesign/input#Form_%3Cinput%3E_types) | text |
