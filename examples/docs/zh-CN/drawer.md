...
<tm-button @click="drawer = true" type="primary" style="margin-left: 16px;">
  点我打开
</tm-button>
...
```html
<tm-button type="text" @click="table = true">打开嵌套表格的 Drawer</tm-button>
<tm-button type="text" @click="dialog = true">打开嵌套 Form 的 Drawer</tm-button>
<el-drawer
  title="我嵌套了表格!"
  :visible.sync="table"
  direction="rtl"
...
<el-drawer
  ...
  <div class="demo-drawer__content">
    ...
    <div class="demo-drawer__footer">
      <tm-button @click="cancelForm">取 消</tm-button>
      <tm-button type="primary" @click="$refs.drawer.closeDrawer()" :loading="loading">{{ loading ? '提交中 ...' : '确 定' }}</tm-button>
    </div>
  </div>
</el-drawer>
...
<el-drawer
  ...
  size="50%">
  <div>
   <tm-button @click="innerDrawer = true">打开里面的!</tm-button>
   <el-drawer
     title="我是里面的"
     :append-to-body="true"
     :before-close="handleClose"
