...
<div class="buttons">
  <tm-button @click="getCheckedNodes">通过 node 获取</tm-button>
  <tm-button @click="getCheckedKeys">通过 key 获取</tm-button>
  <tm-button @click="setCheckedNodes">通过 node 设置</tm-button>
  <tm-button @click="setCheckedKeys">通过 key 设置</tm-button>
  <tm-button @click="resetChecked">清空</tm-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <tm-button size="mini" type="text" on-click={ () => this.append(data) }>Append</tm-button>
              <tm-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</tm-button>
            </span>
          </span>);
      }
    }
